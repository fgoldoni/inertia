            ...
            <div class="fixed z-10 inset-0 overflow-y-auto">
                ...
                <div class="flex items-stretch md:items-center justify-center min-h-full text-center md:px-2 lg:px-4">
                    ...
                    <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 md:translate-y-0 md:scale-95" enter-to="opacity-100 translate-y-0 md:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 md:scale-100" leave-to="opacity-0 translate-y-4 md:translate-y-0 md:scale-95">
                        ...
                        <DialogPanel class="relative text-base bg-secondary-100 text-left transform transition w-full md:max-w-3xl md:px-4 md:my-8 lg:max-w-4xl">
                                        ...
                                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                                            ...
                                            <div class="col-span-1 sm:col-span-3">
                                                ...
                                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                    ...
                                                    <CreateTeamComponent v-model="team" default-open @close-modal="close"></CreateTeamComponent>
