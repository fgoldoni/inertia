...
<template>
    <div v-for="item in stats" :key="item.id" class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 w-full h-full shadow overflow-hidden">
        <dt>
            <div class="absolute bg-green-200 rounded-md p-3">
                <BriefcaseIcon class="h-6 w-6 text-green-700" aria-hidden="true" />
            </div>
...
const stats = [
    { id: 1, name: 'Total Jobs', stat: props.data.companies_count, change: '122', changeType: 'increase' },
]
