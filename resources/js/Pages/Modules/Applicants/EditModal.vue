...
import UpdateApplicantComponent from '@/Components/UpdateApplicantComponent.vue'
import ApplicantStatusComponent from '@/Components/ApplicantStatusComponent.vue'
                                        ...
                                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                                            ...
                                            <div class="col-span-1 sm:col-span-2">
                                                ...
                                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                    ...
                                                    <UpdateApplicantComponent v-model="applicant" default-open></UpdateApplicantComponent>
                                            ...
                                            <div class="col-span-1">
                                                ...
                                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-1">
                                                    <div class="col-span-1">
                                                        <ApplicantStatusComponent v-model="applicant" :states="props.states"></ApplicantStatusComponent>
                                                    </div>
