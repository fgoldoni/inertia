                                                            ...
                                                            <div class="bg-white rounded-lg shadow-md divide-y divide-secondary-200 dark:bg-secondary-800 dark:divide-secondary-700 shadow-md  border-2 border-secondary-200 col-span-1 sm:col-span-2">
                                                                <div class="px-4 py-5 sm:p-6">
                                                                    ...
                                                                    <div class="flex items-center justify-between">
                                                                        ...
                                                                        <button type="button" class="text-sm leading-5 bg-transparent outline-none focus:outline-none text-primary-600 hover:text-primary-700 dark:text-primary-500/50">{{ __('Edit SEO preview') }}</button>
                                                                    </div>
                                                                    ...
                                                                    <div class="mt-5">
                                                                        ...
                                                                        <div class="flex flex-col">
                                                                            ...
                                                                            <span class="mt-1 text-green-600 text-sm leading-5 dark:text-green-500/50">https://privileged-beauty.com/products/38ml-waterproof-lace-wig</span>
                                                                ...
                                                                <div class="px-4 py-5 sm:px-6 space-y-5">
                                                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 space-y-4">
                                                                        ...
                                                                        <div class="col-span-1 sm:col-span-2">
                                                                            ...
                                                                            <JetLabel for="content" value="Seo Description" optional="160 characters"/>
