...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , _hoisted_7)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, "Registered on " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.moment($setup.props.row.created_at, $setup.moment.ISO_8601).format('DD MMM, YYYY')), 1
  /* TEXT */
  )])]);
}
