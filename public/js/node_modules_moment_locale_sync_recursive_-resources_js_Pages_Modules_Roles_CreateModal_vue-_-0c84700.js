...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var _useUsers = (0,_Composables_UseUsers__WEBPACK_IMPORTED_MODULE_1__.useUsers)(),
        ...
        fetchUsers = _useUsers.fetchData,
        groupByFirstLetterData = _useUsers.groupByFirstLetterData;

    var query = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)('');
    var usersByLetter = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)({});
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(selectedPerson, lodash_debounce__WEBPACK_IMPORTED_MODULE_2___default()(function () {
      return usersByLetter.value = groupByFirstLetterData(selectedPerson);
    }, 500), {
      deep: true
    });
    var __returned__ = {
      ...
      groupByFirstLetterData: groupByFirstLetterData,
      query: query,
      usersByLetter: usersByLetter,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* TEXT */
    ...
    users_list: $setup.usersByLetter
  }, null, 8
  /* PROPS */
  , ["users_list"])])])]);
}
...
function useUsers() {
  ...
  var itemsFilter = function itemsFilter(items) {
    return data.value.data.filter(function (item) {
      return items.value.includes(item.id);
    });
  };

  var groupByFirstLetterData = function groupByFirstLetterData(items) {
    return itemsFilter(items).reduce(function (r, e) {
